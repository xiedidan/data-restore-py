...
Usage:
    ...
    python create_tables.py --pg-database mydb --drop-existing --config config.yaml
"""
...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python create_tables.py --pg-database mydb
  python create_tables.py --pg-database mydb --drop-existing
  python create_tables.py --pg-database mydb --pg-schema custom_schema --config config.yaml
  python create_tables.py --pg-database mydb --stop-on-error --log-level DEBUG
        """
    )
